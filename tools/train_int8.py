...
def parse_config():
    ...
    parser.add_argument('--qat', action='store_true', default=False, help='enable QAT training for spconv backbone')
...
def main():
    ...
    if args.qat:
        try:
            ...
            logger.warning(f'Failed to enable QAT on backbone_3d: {e}')
